...
export const featuredGames: FeaturedGame[] = [
  { id: '1', name: 'Rust', description: 'Survival, base building, and community servers.', platform: 'PC' },
  { id: '2', name: 'Sea of Thieves', description: 'Pirate adventure and crew gameplay.', platform: 'PC / Xbox' },
  { id: '3', name: 'Valheim', description: 'Viking survival and exploration.', platform: 'PC' },
  { id: '4', name: 'Variety', description: 'Other games and new releases as they land.', platform: 'PC' },
];
